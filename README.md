...
### (2) Using pip
For now, pip instalization not yet supported. Future updates will support pip instalization.

## 2. Usage step by step 
There are several steps that you must do before running `gc-depth-plot.py`. The main purpose for the initial step is to generate sequencing depth information in specific window size.
